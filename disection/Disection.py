...
class Individual:
    ...
    def __init__(self):
        ...
        self.input = self.readCSV('../input.xlsx', end=1300)  # end between 900-1400

        self.test = self.readCSV('../Test_values.xlsx', end=2077)
    ...
    def fitness(self):
        ...
        for inputN in self.virtualInput:
            try:
                ...
                fit += (self.virtualOutput[candidate] * 100 - output * 100) ** 2
